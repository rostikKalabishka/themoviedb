...
MovieDetails _$MovieDetailsFromJson(Map<String, dynamic> json) => MovieDetails(
      ...
      spokenLanguages: (json['spoken_languages'] as List<dynamic>)
          .map((e) => SpokeLanguage.fromJson(e as Map<String, dynamic>))
          .toList(),
...
SpokeLanguage _$SpokeLanguageFromJson(Map<String, dynamic> json) =>
    SpokeLanguage(
...
Map<String, dynamic> _$SpokeLanguageToJson(SpokeLanguage instance) =>
    <String, dynamic>{
