...
import '../movie_details_cast/movie_details_cast.dart';
import '../movie_details_video/movie_details_video.dart';
...
class MovieDetails {
  ...
  final int revenue;
  final int runtime;
  final List<SpokeLanguage> spokenLanguages;
  final String status;
...
class SpokeLanguage {
  ...
  factory SpokeLanguage.fromJson(Map<String, dynamic> json) =>
      _$SpokeLanguageFromJson(json);
  Map<String, dynamic> toJson() => _$SpokeLanguageToJson(this);
}
